...
We are using a stock exchange dataset that was collected from Yahoo Finance, containing the daily price data for stock market indices across the world. Each record contains the following information for each trading day:
